  ...
  return (
    <div className=' h-full w-full flex flex-col'>
      <div className=' h-20 px-10  py-2 w-full flex justify-between items-end '>
        <p className=' font-semibold text-xl'>Courses List</p>
      ...
      <div className=' w-full grow flex flex-col items-center py-4'>
        <div className=' w-[60%] font-medium text-lg grid grid-cols-5 h-12 bg-slate-300 place-content-center place-items-center rounded-lg'>
          <p>S.no</p>
          <p>Course Code</p>
          <p>Course Name</p>
          <p>Department</p>
        ...
        {isLoading ? <img src={loading} alt="" className=' h-12 w-12 absolute top-1/2' /> : CourseData.map((item, index) =>
          <div key={index} className={` w-[60%] font-normal text-sm grid grid-cols-5 h-12 border-b place-content-center place-items-center rounded-lg`}>
            <p>{item.id}</p>
            <p>{item.code}</p>
